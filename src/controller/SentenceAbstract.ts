...
//
// export default abstract class SentenceText {
...
//         this.sentenceData = this.initializeSentenceTokens();
//     }
//
...
//     }
//
//     protected abstract initializeSentenceTokens(): ISentenceData[];
//
//     protected abstract tokenizeSentence(sentence: string): string[];
//
